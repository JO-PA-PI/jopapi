...
AMPLADA = 800
ALTURA = 600
BACKGROUND_IMAGE = 'assets/fons10.png'
MUSICA_FONS = 'assets/music.mp3'
SONIDO_DISPARO = 'assets/disparo.mp3'  # Añadimos un sonido para los disparos
WHITE = (255,255,255)
MAGENTA = (255,0,255)
GREEN = (0,255,0)
RED = (255,0,0)
...
vides_jugador1 = 3
vides_jugador2 = 3
vides_jugador1_image = pygame.image.load('assets/ratchet.png')
...
sonido_disparo = pygame.mixer.Sound(SONIDO_DISPARO)
...
def show_credits():
    ...
    text4 = "Sons:"
    text5 = "Joel Paredes"
    text6 = "Shunsuke Kikuchi (Dragon Ball Z)"
    text7 = "Freesound.org"
    font0 = pygame.font.SysFont(None, 100)
...
while True:
        ...
        if pantalla_actual == 1:
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_1:
                    ...
                    if not musica_reproduint:
                        pygame.mixer.music.play(-1)  # -1 reproduce en bucle indefinido
                        musica_reproduint = True
                if event.key == K_2:
                    pantalla_actual = 2
        # crèdits
    ...
    if pantalla_actual == 4:
        imprimir_pantalla_fons('assets/gameover2.png')
    ...
    if pantalla_actual == 3:
        # Si cambia a pantalla 3 y la música no está reproduciéndose, iniciarla
        if not musica_reproduint:
            pygame.mixer.music.play(-1)  # -1 reproduce en bucle indefinido
            musica_reproduint = True
